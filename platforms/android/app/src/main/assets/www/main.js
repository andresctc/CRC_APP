...
const routes = [
    ...
    {
        path: '',
        redirectTo: 'capturarfotos',
        pathMatch: 'full'
    },
    {
        path: 'capturarfotos',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_capturarfotos_capturarfotos_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./capturarfotos/capturarfotos.module */ 1005)).then(m => m.CapturarfotosPageModule)
    },
];
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        ...
        providers: [
            ...
            _awesome_cordova_plugins_camera_preview_ngx__WEBPACK_IMPORTED_MODULE_3__.CameraPreview
        ],
