...
export class MenuPage implements OnInit {
  ...
  ocrImagen(img: string, cara: any) {
    ...
    .then((res: OCRResult) => {
      console.log(res);
      const vLectura = {
        lectura: JSON.stringify(res.words.wordtext)
      };
      ...
      if(cara === 1) {
        ...
        if(esNumero.test(this.replaceAll(res.words.wordtext[8],'.', ''))) {
          ...
          this.scanData.primerApellido = res.words.wordtext[9];
          this.scanData.segundoApellido = res.words.wordtext[10];
          this.scanData.primerNombre = res.words.wordtext[12];
          this.scanData.segundoNombre = res.words.wordtext[13];
        }
        ...
        if(esNumero.test(this.replaceAll(res.words.wordtext[9],'.', ''))) {
          ...
          this.scanData.primerApellido = res.words.wordtext[10];
          this.scanData.segundoApellido = res.words.wordtext[11];
          if (res.words.wordtext[12].length < 3 || res.words.wordtext[12] ==='APELLIDOS') {
            this.scanData.primerNombre = res.words.wordtext[13];
            if(res.words.wordtext[14] !== 'NOMBRES'){
              this.scanData.segundoNombre = res.words.wordtext[14];
            } else {
              this.scanData.segundoNombre = '';
            }
          } else if (res.words.wordtext[13].length < 3 || res.words.wordtext[13] ==='APELLIDOS') {
            this.scanData.primerNombre = res.words.wordtext[14];
            if(res.words.wordtext[15] !== 'NOMBRES'){
              this.scanData.segundoNombre = res.words.wordtext[15];
            } else {
              this.scanData.segundoNombre = '';
            }
          } else {
        ...
        if(esNumero.test(this.replaceAll(res.words.wordtext[10],'.', ''))) {
          ...
          if (res.words.wordtext[13].length < 3 || res.words.wordtext[13] ==='APELLIDOS') {
            this.scanData.primerNombre = res.words.wordtext[14];
            if(res.words.wordtext[15] !== 'NOMBRES'){
              this.scanData.segundoNombre = res.words.wordtext[15];
            } else {
          ...
          } else if (res.words.wordtext[14].length < 3 || res.words.wordtext[14] ==='APELLIDOS') {
            this.scanData.primerNombre = res.words.wordtext[15];
            if(res.words.wordtext[16] !== 'NOMBRES'){
              this.scanData.segundoNombre = res.words.wordtext[16];
            } else {
              this.scanData.segundoNombre = '';
            }
          } else {
        ...
        if(esNumero.test(this.replaceAll(res.words.wordtext[11],'.', ''))) {
          ...
          this.scanData.primerApellido = res.words.wordtext[12];
          this.scanData.segundoApellido = res.words.wordtext[13];
          if (res.words.wordtext[14].length < 3 || res.words.wordtext[14] ==='APELLIDOS') {
            this.scanData.primerNombre = res.words.wordtext[15];
            if(res.words.wordtext[16] !== 'NOMBRES'){
              this.scanData.segundoNombre = res.words.wordtext[16];
            } else {
          ...
          } else if (res.words.wordtext[15].length < 3 || res.words.wordtext[15] ==='APELLIDOS') {
            this.scanData.primerNombre = res.words.wordtext[16];
            if(res.words.wordtext[17] !== 'NOMBRES'){
              this.scanData.segundoNombre = res.words.wordtext[17];
            } else {
              this.scanData.segundoNombre = '';
            }
          } else {
