...
let GeneralService = class GeneralService {
     ...
     **/
    constructor(route, http, location, utils) {
        this.route = route;
        this.http = http;
     ...
     * ```
     */
    getMethod(urlRoute, parameters, payload) {
        const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.pathHost}${urlRoute}`;
        if (parameters !== null) {
            if (payload) {
                const payloads = {
                    params: parameters,
                ...
                return this.http.get(url, payloads);
            }
            else {
     ...
     * @returns
     */
    postMethod(urlRoute, body, cabez) {
        //console.log(body);
        const path = `${_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.pathHost}${urlRoute}`;
        // console.log(path);
        // const vHeaders = {
     ...
     **/
    updateMethod(urlRoute, pathName, body) {
        const path = `${_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.pathHost}${urlRoute}`;
...
GeneralService = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
...
/* harmony export */ });
/* harmony import */ var D_Repositorio_AngularCompartido_CodensaApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,D_Repositorio_AngularCompartido_CodensaApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,D_Repositorio_AngularCompartido_CodensaApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,D_Repositorio_AngularCompartido_CodensaApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
